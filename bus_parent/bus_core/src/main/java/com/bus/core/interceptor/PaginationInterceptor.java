...
import com.bus.core.dialect.Dialect;
import com.bus.core.dialect.MySql5Dialect;
import com.bus.core.dialect.PageContext;
import com.bus.core.dialect.ReflectHelper;
import com.bus.vo.HandlerResult;
...
public class PaginationInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (parameterObject != null)
			page = (PageVO) ReflectHelper.isPage(parameterObject, "pageVO");
		...
		if(page!=null){
			List<HandlerResult> list = new ArrayList<HandlerResult>() ;
			HandlerResult aa= new HandlerResult();
			aa.setResultObj(invocation.proceed());
			aa.setPageVO(page);
			list.add(aa);
			return list;
		}else{
