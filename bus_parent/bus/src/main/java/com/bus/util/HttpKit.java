...
public class HttpKit {
	...
	private static final int CONNECT_TIME_OUT = 5000; //链接超时时间3�?

	private static SSLContext wx_ssl_context = null; //微信支付ssl证书
	
	static{
		
		Resource resource = new ClassPathResource("wx_apiclient_cert.p12"); //获取微信证书 或�?直接从文件流读取
		char[] keyStorePassword = Constant.WEIXIN_MCH_ID.toCharArray(); //证书密码
		try {
