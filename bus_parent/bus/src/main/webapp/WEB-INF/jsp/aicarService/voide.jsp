...
<div align="center" id="logindFont">获取视频中...</div>
 ...
 <div class="row"  style="display:none;" id="showPhoto">
   ...
   <div class="row">
   <video width="320" height="240" id="voide"  controls>
        <source src="myvideo.mp4" type="vedio/mp4">
        <source src="myvideo.ogv" type="vedio/ogg">
        <source src="myvideo.webm" type="vedio/webm">
   </vedio>
   </div>
   </div>
   </div>
  ...
  <a class="weui-btn weui-btn_primary">结束监控</a>
  </div>
   ...
   <div class="row" align="center" style="margin-top:10%;text-align:center;  ">
...
<script type="text/javascript">
 var imsi = "${imsi}" ;
  setTimeout(function() {
	$.ajax({
	    async:false,
	    url:"services/api/mobleCar/getVoide",
	    data:{"imsi":imsi},
