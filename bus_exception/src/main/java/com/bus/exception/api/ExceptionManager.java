...
import com.bus.exception.ifs.IExceptionManager;
 ...
 * 使用统一的异常定义
 * @see com.bus.exception.UnifiedException
 * 异常的处理以责任链的方式进行
 * @see com.bus.exception.handler.ExceptionHandlerChain
 * 可以自定义异常处理类
 * @see com.bus.exception.handler.AbsExceptionHandler
 * <br>
 *
 * @author xms<br>
 * @version 1.0<br>
